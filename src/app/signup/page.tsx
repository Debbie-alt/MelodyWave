...
export default function SignUp() {
    ...
    return (
        <>
            <div className=" bg-gradient-to-tr from-purple-400 to-[#040f0f] min-h-screen">
                ...
                <section className=" flex flex-col items-center justify-center relative  py-14">
                    ...
                    <figure className="rounded-full" >
                        ...
                        <form onSubmit={signUp} className="mb-5 logform p-7 w-[85vw] md:w-[70vw] lg:w-[50vw] flex flex-col items-center rounded-l-lg rounded-b-lg sm:rounded-l-full  sm:rounded-b-full">
                            <h2 className="text-center text-md md:text-lg text-white mb-10 mt-5 quicksand-reg font-serif italic">
                    </h2>
                            <fieldset className=" space-y-6 w-[90%] md:w-3/5">
                            <div className="relative w-full">
                                    <img width="24" height="24" src="https://img.icons8.com/ios/50/username.png" alt="username" className="absolute mt-3 mx-3 mr-3" />
                                    <input type="text" placeholder="  Enter your email address" className="px-9 py-3 rounded-full bg-slate-200 w-full quicksand-reg text-sm sm:text-base" value={email} onChange={(e)=> setEmail(e.target.value)} />
                                </div>

                                <div className="relative w-full">
                                    <img width="24" height="24" src="https://img.icons8.com/ios/50/username.png" alt="username" className="absolute mt-3 mx-3 mr-3" />
                                    <input type="text" placeholder="Create username" className="px-9 py-3 rounded-full bg-slate-200 w-full quicksand-reg  text-sm sm:text-base" value={username} onChange={(e)=> setUsername(e.target.value)} />
                                
                                </div>

                                <div className="relative w-full">
                                    <img width="24" height="24" src="https://img.icons8.com/cotton/64/lock--v3.png" alt="lock--v3" className="absolute mt-3 mx-3 mr-3" />
                                    <input type="password" placeholder="Create password" className=" text-sm sm:text-base px-9 py-3 rounded-full bg-slate-200 w-full"  value={password} onChange={(e)=> setPassword(e.target.value)}/>
                                </div>
                            </fieldset>
