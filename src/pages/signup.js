            ...
            <main class=" bg-gradient-to-tr from-purple-400 to-[#040f0f]">
                ...
                <section className="container flex flex-col items-center justify-center relative  py-14">
                    ...
                    <figure className="rounded-full" >
                        ...
                        <form onSubmit={signUp} class="mb-5 logform p-7 w-[85vw] sm:w-[50vw] flex flex-col items-center rounded-l-full  rounded-b-full">
                            ...
                            <div class="relative w-full">
                                ...
                                <div class="relative w-full">
                                    <img width="24" height="24" src="https://img.icons8.com/ios/50/username.png" alt="username" className="absolute mt-3 mx-3 mr-3" />
                                    <input type="text" placeholder="Create username" class="px-9 py-3 rounded-full bg-slate-200 w-full quicksand-reg" value={username} onChange={(e)=> setUsername(e.target.value)} />
                                
                                </div>

                                <div className="relative w-full">
                                    <img width="24" height="24" src="https://img.icons8.com/cotton/64/lock--v3.png" alt="lock--v3" className="absolute mt-3 mx-3 mr-3" />
                                    <input type="password" placeholder="Create password" class="px-9 py-3 rounded-full bg-slate-200 w-full"  value={password} onChange={(e)=> setPassword(e.target.value)}/>
                                </div>
                            </fieldset>
                        ...
                        {/* <hr/> */}
                          <div className="space-y-5">
                             <button onClick={signupWithGoogle} className="flex items-center justify-center space-x-10 border  border-purple-200 p-2 rounded-full w-3/4 mx-auto text-white">
